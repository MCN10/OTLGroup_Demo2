...
urlpatterns = [
    ...
    path('HouseOfBrands/', include('HouseOfBrands.urls', namespace='houseOfBrands')),
    path('NewTwinkleVision/', include('NewTwinkleVision.urls', namespace='newTwinkleVision')),
    path('OpticalLensLab/', include('OpticalLensLab.urls', namespace='opticalLensLab')),
    path('OpticalSpares/', include('OpticalSpares.urls', namespace='opticalSpares')),
    path('OpticTradeLinks/', include('OpticTradeLinks.urls', namespace='opticTradeLinks')),
